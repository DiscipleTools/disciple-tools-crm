...
//        add_action( "dt_details_additional_section", [ $this, "dt_add_section" ], 30, 2 );
    ...
    public function dt_details_additional_tiles( $tiles, $post_type = "" ) {
        if ( $post_type === "contacts" || $post_type === "crm" ){
            $tiles["disciple_tools_crm"] = [ "label" => __( "CRM Plugin", 'disciple-tools-crm' ) ];
        }
        return $tiles;
    }
    ...
    public function dt_custom_fields( array $fields, string $post_type = "" ) {
        ...
        if ( $post_type === "contacts" || $post_type === "crm"){
             ...
             */
            $fields['disciple_tools_crm_text'] = [
                'name'        => __( 'Text', 'disciple-tools-crm' ),
                'description' => _x( 'Text', 'Optional Documentation', 'disciple-tools-crm' ),
                'type'        => 'text',
                'default'     => '',
                'tile' => 'disciple_tools_crm',
                'icon' => get_template_directory_uri() . '/dt-assets/images/edit.svg',
            ];
            /**
             * This is an example of a multiselect field
             */
            $fields["disciple_tools_crm_multiselect"] = [
                "name" => __( 'Multiselect', 'disciple-tools-crm' ),
                "default" => [
                    "one" => [ "label" => __( "One", 'disciple-tools-crm' ) ],
                    "two" => [ "label" => __( "Two", 'disciple-tools-crm' ) ],
                    "three" => [ "label" => __( "Three", 'disciple-tools-crm' ) ],
                    "four" => [ "label" => __( "Four", 'disciple-tools-crm' ) ],
                ],
                "tile" => "disciple_tools_crm",
                "type" => "multi_select",
                "hidden" => false,
             ...
             */
            $fields["disciple_tools_crm_keyselect"] = [
                'name' => "Key Select",
                'type' => 'key_select',
                "tile" => "disciple_tools_crm",
                'default' => [
                    'first'   => [
                        "label" => _x( 'First', 'Key Select Label', 'disciple-tools-crm' ),
                        "description" => _x( "First Key Description", "Training Status field description", 'disciple-tools-crm' ),
                        'color' => "#ff9800"
                    ],
                    'second'   => [
                        "label" => _x( 'Second', 'Key Select Label', 'disciple-tools-crm' ),
                        "description" => _x( "Second Key Description", "Training Status field description", 'disciple-tools-crm' ),
                        'color' => "#4CAF50"
                    ],
                    'third'   => [
                        "label" => _x( 'Third', 'Key Select Label', 'disciple-tools-crm' ),
                        "description" => _x( "Third Key Description", "Training Status field description", 'disciple-tools-crm' ),
                        'color' => "#366184"
                    ],
                ],
                'icon' => get_template_directory_uri() . '/dt-assets/images/edit.svg',
    ...
    public function dt_add_section( $section, $post_type ) {
         ...
         */
        if ( ( $post_type === "contacts" || $post_type === "crm" ) && $section === "disciple_tools_crm" ){
            /**
...
Disciple_Tools_CRM_Tile::instance();
